...
def main(args):
    ...
    out = RocCurveDisplay.from_predictions(merged_csv["spurious"], train_probs_df["probs_1_jtt"], ax=ax, name="JTT")
    # out.line_.set_linewidth(3.)   
    # out.line_.alpha = 0.8
    out2 = RocCurveDisplay.from_predictions(merged_csv["spurious"], train_probs_df["probs_1"], ax=ax, name="MAP-D")
